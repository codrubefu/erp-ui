  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 py-12 text-slate-900">
      <div className="mx-auto max-w-4xl rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-3 text-slate-600">Am adaugat routing cu React Router si pagini separate.</p>

        <div className="mt-8 flex flex-wrap gap-3">
          <Link to="/erp" className="rounded-2xl bg-violet-600 px-4 py-2.5 text-sm font-semibold text-white">Deschide aplicatia ERP</Link>
