...
const SECTION_IDS: SectionId[] = ['dashboard', 'profile-info', 'profile-security', 'profile-privacy', 'profile-events', 'profile-subscriptions', 'branches', 'location-groups', 'admins', 'access', 'custom-fields', 'members', 'subscriptions', 'events', 'articles', 'campaigns', 'announcements', 'sms', 'payments', 'reports'];
